  ...
  if (user && user.plan !== "pro" && user.plan !== "pro_trial" && user.plan !== "standard") {
    return (
      <div className="min-h-screen bg-[#08090c] text-white flex flex-col justify-center items-center relative overflow-hidden">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[500px] w-[500px] rounded-full bg-electric-500/[0.05] blur-[150px]" />
        
        <div className="relative z-10 glass-card p-10 border border-electric-500/30 bg-electric-950/20 max-w-lg w-full text-center rounded-2xl mx-4">
          <div className="absolute top-0 right-0 h-40 w-40 rounded-full bg-electric-500/10 blur-3xl" />
          <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-electric-500/10 text-electric-400 mx-auto mb-6">
            <svg className="h-8 w-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
            </svg>
          </div>
          <span className="text-[10px] font-bold text-electric-400 uppercase tracking-widest block mb-2">
            PREMIUM FEATURE REQUIRED
          </span>
          <h3 className="text-2xl font-bold text-white mb-3">Historical Backtester</h3>
          <p className="text-sm text-gray-400 max-w-md mx-auto leading-relaxed mb-8">
            The Backtest Engine is a Premium feature. Upgrade to Standard or Pro to unlock historical simulations, multi-asset portfolio tests, and strategy optimization tools.
          </p>
          <div className="flex flex-col items-center justify-center gap-4">
            <Link
              href="/dashboard/pricing"
              className="w-full block py-3 bg-gradient-to-r from-electric-500 to-indigo-500 hover:from-electric-600 hover:to-indigo-600 text-white font-bold rounded-xl text-xs uppercase tracking-wider transition duration-300 shadow-md shadow-electric-500/20"
            >
              View Pricing Plans
            </Link>
            <Link
